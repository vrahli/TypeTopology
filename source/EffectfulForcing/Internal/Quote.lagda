...
qν₀ : {Γ : Cxt} {σ : type}  → QT (Γ ,, σ) σ
qν₀ {Γ} {σ} = T→QT ν₀

qν₁ : {Γ : Cxt} {σ₁ σ₂ : type} → QT (Γ ,, σ₁ ,, σ₂) σ₁
qν₁ {Γ} {σ₁} {σ₂} = T→QT ν₁

qν₂ : {Γ : Cxt} {σ₁ σ₂ σ₃ : type} → QT (Γ ,, σ₁ ,, σ₂ ,, σ₃) σ₁
qν₂ {Γ} {σ₁} {σ₂} {σ₃} = T→QT ν₂

qν₃ : {Γ : Cxt} {σ₁ σ₂ σ₃ σ₄ : type} → QT (Γ ,, σ₁ ,, σ₂ ,, σ₃ ,, σ₄) σ₁
qν₃ {Γ} {σ₁} {σ₂} {σ₃} {σ₄} = T→QT ν₃

qν₄ : {Γ : Cxt} {σ₁ σ₂ σ₃ σ₄ σ₅ : type} → QT (Γ ,, σ₁ ,, σ₂ ,, σ₃ ,, σ₄ ,, σ₅) σ₁
qν₄ {Γ} {σ₁} {σ₂} {σ₃} {σ₄} {σ₅} = T→QT ν₄
